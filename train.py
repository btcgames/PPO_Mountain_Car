...
PPO_EPS = 0.2 # ограничивает размер обновления весов стратегии
PPO_EPOCHES = 10
PPO_BATCH_SIZE = 64
...
if __name__ == "__main__":
    ...
    with ptan.common.utils.RewardTracker(writer) as tracker:
        for step_idx, exp in enumerate(exp_source):
            ...
            if step_idx % TEST_ITERS == 0:
                ...
                if best_reward is None or best_reward < rewards:
                    if best_reward is not None:
                        ...
                        torch.save(net_act.state_dict(), 'best_' + str(rewards))
                    if rewards > 90:
                        break
                    best_reward = rewards
            ...
            # если достаточно опыта, можно обучать
            ...
            # тк при вычислении A, Q (calc_adv_ref) отбросили последние значения
            ...
            for epoch in range(PPO_EPOCHES):
                # делим траекторию на батчи размером PPO_BATCH_SIZE
